...
import { seedChatrooms } from "./chatrooms";
...
async function main() {
  ...
  try {
    ...
    console.warn(
      "Importing actors from JSON failed; falling back to static seeds. Error:",
      (e as Error).message
    );
  ...
  try {
    ...
    console.warn(
      "[seed:user_photos] Skipping user photos seeding:",
      (e as Error).message
    );
  }
  ...
  try {
    ...
    console.warn(
      "[seed:airports] Skipping airports seeding:",
      (e as Error).message
    );
  }
  ...
  try {
    ...
    console.warn(
      "[seed:bookmarks] Skipping bookmarks seeding:",
      (e as Error).message
    );
  }
